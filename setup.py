...
NAME = 'upstream_ws'
SHORT_NAME = 'upstream'
VCS_URL = 'https://gitlab.com/pursway-group/dev/python/upstream_ws'
...
# lnk_data = os.path.join('pursway', SHORT_NAME, 'data')
...
try:
    ...
    setup(
        ...
        # data_files=[(f'Lib/site-packages/pursway/{SHORT_NAME}', ['data/config.yml', 'data/requirements-src.txt',
        #                                                    'data/driver.py']),
        #             #(f'lib/python3.7/site-packages/pursway/{SHORT_NAME}', ['requirements-src.txt'])
        #             ],
        # package_data={'pursway.{SHORT_NAME}': ['data/*', 'data/config.yml',
        #                                   'data/requirements-stc.txt', 'data/requirements-dest.txt']},
        # package_data={f'pursway.{SHORT_NAME}': ['data/*'
        #                                         ]},

        package_data={f'pursway.{SHORT_NAME}': ['resources/*'
                                                ]},
        include_package_data=True,
        install_requires=install_requires,
        # entry_points={"console_scripts": [
        #     f"python-{SHORT_NAME}-tool=pursway.{SHORT_NAME}.data.__main__:main"
        # ]},
