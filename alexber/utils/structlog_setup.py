...
try:
    ...
    warning = (
        ...
        "please run 'python -m pip install alex-ber-utils[structlog]'."
    )
...
def initConf():
    ...
    log_file_name = parse_str(os.getenv("LOG_FILE_NAME", "logname.log"))
    if log_file_name and (not log_file_name.endswith(".log")):
        log_file_name += ".log"
